...
urlpatterns = [
    ...
    path('college/<str:college_id>/login_page/', views.login_page,name="login_page"),
    path('college/<str:college_id>/user_login/', views.user_login,name="user_login"),   
    path('college/<str:college_id>/user_logout/', views.user_logout,name="user_logout"),   
    path('college/<str:college_id>/teacher_home/', views.teacher_home,name="teacher_home"),   
    path('college/<str:college_id>/student_home/', views.student_home,name="student_home"),
